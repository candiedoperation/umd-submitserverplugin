...
- [Download the plugin file](https://github.com/candiedoperation/umd-submitserverplugin/releases/download/v1.0.2/umd-submitserverplugin-1.0.2.zip) from this release
